# RESTful IOT API Node Server Boilerplate

[![Build Status](https://app.travis-ci.com/obe711/node-iot-server-boilerplate.svg?branch=main)](https://app.travis-ci.com/obe711/node-server-boilerplate)
...
```bash
git clone --depth 1 https://github.com/obe711/node-iot-server-boilerplate.git
