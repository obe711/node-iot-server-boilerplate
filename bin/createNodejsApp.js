...
if (process.argv.length < 3) {
  ...
  console.log('    npx create-node-iot-server my-app');
  console.log('    OR');
  console.log('    npm init node-iot-server my-app');
  process.exit(1);
}
...
const repo = 'https://github.com/obe711/node-iot-server-boilerplate.git';
